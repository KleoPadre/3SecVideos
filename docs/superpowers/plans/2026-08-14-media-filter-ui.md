...
### Task 1: Чистые функции обработки медиа
...
### Task 2: Операции, сводка и зависимости
...
### Task 3: Тёмный графический интерфейс и миграция
...
- [ ] Зафиксировать только относящиеся к миграции файлы: `git add run.py tests/test_run.py README.md video_filter.py mov.py iphone_screens.py && git commit -m "Создано единое приложение обработки медиа"`.
